...
export function applyExemptions(atom, facts) {
  // A null record carries no exemptions, which is the SAFE reading: the alternative is a throw
  // that a caller could mistake for "exempt". Never let an error path resolve toward relief.
  atom = atom ?? {}; facts = facts ?? {};
